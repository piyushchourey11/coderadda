...
if (wpqa_is_user_followers() || wpqa_is_user_following() || $last_one == "followers" || $last_one == "following") {
	...
	if (isset($follow_user) && is_array($follow_user) && !empty($follow_user)) {
		...
		echo '<div class="alert-message warning"><i class="icon-flag"></i><p>'.(wpqa_is_user_followers() || $last_one == "followers"?esc_html__("Author doesn't have any followers yet.","wpqa"):esc_html__("Author doesn't follow anyone.","wpqa")).'</p></div>';
	}
}?>