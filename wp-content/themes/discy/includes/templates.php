<?php if (isset($wp_page_template) && $wp_page_template == "template-home.php") {
	...
	$post_display    = $post_single_category = $post_categories = $post_exclude_categories = $post_posts = "";
	if (isset($first_one) && ($first_one == "all" || $first_one == $recent_questions_slug || $first_one == $answers_slug || $first_one == $most_answers_slug || $first_one == $no_answers_slug || $first_one == $most_visit_slug || $first_one == $most_vote_slug || $first_one == $random_slug || $first_one == $question_new_slug || $first_one == $question_sticky_slug || $first_one == $question_polls_slug || ($question_bump == "on" && $active_points == "on" && ($first_one == $question_bump_slug || $first_one == $question_bump_slug_2)) || $first_one == $recent_questions_slug_2 || $first_one == $answers_slug_2 || $first_one == $most_answers_slug_2 || $first_one == $no_answers_slug_2 || $first_one == $most_visit_slug_2 || $first_one == $most_vote_slug_2 || $first_one == $random_slug_2 || $first_one == $question_new_slug_2 || $first_one == $question_sticky_slug_2 || $first_one == $question_polls_slug_2)) {
		$taxonomy  = 'question-category';
		$post_type = 'question';
	}else if (isset($first_one) && ($first_one == $recent_posts_slug || $first_one == $recent_posts_slug_2)) {
		$taxonomy  = 'category';
		$post_type = 'post';
	}
