			...
			<?php if (!isset($its_not_login)) {?>
				<div class="mobile-menu-top mobile--top">
					<div class="widget widget_ask">
						<?php if (function_exists('wpqa_add_question_permalink')) {?>
				...
				<?php if ($active_mobile_menu == "on") {
					...
					if ($sidebar_where == "menu_sidebar" || $sidebar_where == "menu_left") {?>
						<div class="mobile-menu-left">
							<?php wp_nav_menu(array('container' => '','container_class' => 'nav_menu','menu_id' => 'nav_menu','theme_location' => 'discy_explore','fallback_cb' => 'discy_nav_fallback'));?>
						</div><!-- End mobile-menu-left -->
					<?php }
				}
			}
			if ($active_mobile_menu != "on" && $big_search != "on") {?>
				<div class="mobile--top">
					<?php $register_menu_array = (isset($its_not_login)?array('menu' => $register_menu):array('theme_location' => 'header_menu'));
