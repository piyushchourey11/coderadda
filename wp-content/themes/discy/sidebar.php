...
if (is_single() || (class_exists('WPQA') && wpqa_is_search() && wpqa_search_type() == "posts") || is_page()) {
...
}else if ((is_single() || (class_exists('WPQA') && wpqa_is_search() && wpqa_search_type() == "posts") || is_page()) && $discy_what_sidebar != "default" && $discy_what_sidebar != "") {
