...
if (is_admin() && ! function_exists( 'discy_admin_init' ) ) :
	function discy_admin_init() {
		...
		require_once get_parent_theme_file_path("admin/includes/admin_options.php");
		require_once get_parent_theme_file_path("admin/includes/options_sanitization.php");
		require_once get_parent_theme_file_path("admin/option.php");
