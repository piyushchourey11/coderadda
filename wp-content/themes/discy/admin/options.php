...
function discy_admin_options() {
	...
	$options[] = array(
		'name' => esc_html__('Active the add question button at the site','discy'),
		'desc' => esc_html__('Select ON if you want to active the add question button at the site beside go to up button.','discy'),
		'id'   => 'ask_button',
		'type' => 'checkbox'
	);
	...
	$options[] = array(
		'name' => esc_html__('Tags enable or disable in add post form','discy'),
		'desc' => esc_html__('Select ON to enable the tags in add post form.','discy'),
		'id'   => 'tags_post',
		'std'  => 'on',
		'type' => 'checkbox'
	);
	...
	$options[] = array(
		'name' => esc_html__('Attachment in add post form','discy'),
		'desc' => esc_html__('Select ON to enable the attachment in add post form.','discy'),
		'id'   => 'attachment_post',
		'std'  => 'on',
		'type' => 'checkbox'
	);
	...
	$options[] = array(
		'name' => esc_html__('Details in add post form is required','discy'),
		'id'   => 'content_post',
		'std'  => 'on',
		'type' => 'checkbox'
	);
	...
	if (class_exists("WPQA")) {
		...
		$options[] = array(
			'name' => esc_html__('Click ON, if you need to remove the question slug and put / in the questions slug.','discy'),
		...
		$options[] = array(
			'name' => esc_html__('Add questions','discy'),
			'type' => 'info'
		);
		
		$options[] = array(
			'name' => esc_html__('Add question slug','discy'),
			'desc' => esc_html__('Put the add question slug.','discy'),
		...
		if (class_exists("WPQA")) {
			$html_content = '<a href="'.wpqa_add_question_permalink().'" target="_blank">'.esc_html__('The Link For The Add Question Page.','discy').'</a>';
		...
		$options[] = array(
			'name' => esc_html__('Editor enable or disable for details in add question form','discy'),
	...
	$options[] = array(
		'name' => esc_html__('Active the activity login site?','discy'),
	...
	$edit_profile_items_2 = array(
		...
		"gplus"     => array("sort" => esc_html__('Google plus','discy'),"value" => "gplus"),
	...
	$options[] = array(
		'name' => esc_html__('Points choose best answer','discy'),
		'desc' => esc_html__('put the Points choose best answer','discy'),
	...
	$social = array(
		...
		array('name' => esc_html__('Google','discy'),"value" => "gplus","icon" => "gplus","default" => "yes"),
	...
	$options[] = array(
		...
		'desc' => esc_html__("Add your email for email template",'discy'),
		'id'   => 'email_template',
		'std'  => get_bloginfo("admin_email"),
		'type' => 'text'
	);
	...
	*/
	...
	$options[] = array(
		'name'      => esc_html__('Post meta field.','discy'),
