jQuery(document).ready(function($) {
	jQuery(window).load(function() {
		...
		jQuery(".image-remove-media").live("click",function () {
			...
			jQuery('.discy_framework .sort-sections').each(function () {
				if (!jQuery(this).hasClass("not-sort") && jQuery(this).hasClass("sort-sections-with")) {
					jQuery(this).sortable({
						...
						cancel: ".builder-toggle-open,.builder-toggle-close,.builder_clone,.del-builder-item",
		...
		/* Sort elements */
		jQuery("#builder,#builder_slide").sortable({placeholder: "ui-state-highlight",handle: ".widget-head",cancel: ".builder-toggle-open,.builder-toggle-close,.builder_clone,.del-builder-item"});
		...
		jQuery(".discy_framework .add_element").on("click",function () {
			...
			if (!add_element.hasClass("not_add_element")) {
				...
				if (add_element.hasClass("no_discy_theme")) {
					var discy_theme_var = "";
					var data_id_name = data_id;
					var data_add_to_name = data_add_to;
				}
				...
				update_form_elements(jQuery('#'+element_id));
				...
				jQuery('#'+element_id+' .builder-datepicker').removeClass("builder-datepicker").removeClass("hasDatepicker").addClass("discy-datepicker").datepicker();
			}
		});
		...
		jQuery("#discy_builder_meta_tab,#discy_slideshow_post").on("click",".add-item",function () {
			...
			if (builder_item == "add_slide") {
				...
				jQuery('#discy_slideshow_post ul').append('<li id="builder_slide_'+builder_slide_j+'" data-id="builder_slide_item['+builder_slide_j+']"><div><a class="widget-handle ui-sortable-handle"><span class="dashicons dashicons-editor-justify"></span></a><a class="del-builder-item del-sidebar-item"><span class="dashicons dashicons-trash"></span></a><div title="Clone" class="builder_clone"><span class="dashicons dashicons-welcome-add-page"></span></div></div><div class="widget-content"><h4 class="heading">Image URL</h4><div class="rwmb-input"><input id="builder_slide_item['+builder_slide_j+'][image_url]" name="builder_slide_item['+builder_slide_j+'][image_url]" type="text" class="upload upload_image_'+builder_slide_j+'"><input class="upload_image_button button upload-button-2" rel="'+builder_slide_j+'" type="button" value="Upload"><input type="hidden" class="image_id" name="builder_slide_item['+builder_slide_j+'][image_id]"></div><div class="clear"></div><h4 class="heading">Slide Link</h4><div class="rwmb-input"><input id="builder_slide_item['+builder_slide_j+'][slide_link]" name="builder_slide_item['+builder_slide_j+'][slide_link]" value="#" type="text"></div><div class="clear"></div></div></li>');
		...
		jQuery(".discy_framework #role_add").click(function() {
			...
			if (role_name != "" ) {
				if( role_name.length){
					...
					jQuery('#roles_list').append('<li id="li_roles_'+roles_j+'"><div class="widget-head">'+role_name+'<a class="del-roles-item del-builder-item del-sidebar-item"><span class="dashicons dashicons-trash"></span></a></div><div class="widget-content"><div class="widget-content-div"><input id="'+discy_js.discy_theme+'['+data_id+'][group_'+ roles_j +'][new]" type="hidden" name="'+discy_js.discy_theme+'['+data_id+'][group_'+ roles_j +'][new]" value="new"><input id="'+discy_js.discy_theme+'['+data_id+'][group_'+ roles_j +'][group]" type="hidden" name="'+discy_js.discy_theme+'['+data_id+'][group_'+ roles_j +'][group]" value="'+role_name+'"><input type="hidden" class="group_role_name" name="'+discy_js.discy_theme+'['+data_id+'][group_'+ roles_j +'][id]" value="group_'+ roles_j +'"><div class="clearfix"></div><div class="section section-checkbox"><div class="option"><div class="controls"><label class="switch" for="'+discy_js.discy_theme+'['+data_id+'][group_'+ roles_j +'][ask_question]"><input id="'+discy_js.discy_theme+'['+data_id+'][group_'+ roles_j +'][ask_question]" value="on" class="checkbox discy-input" type="checkbox" name="'+discy_js.discy_theme+'['+data_id+'][group_'+ roles_j +'][ask_question]"><label for="'+discy_js.discy_theme+'['+data_id+'][group_'+ roles_j +'][ask_question]" data-on="'+discy_js.on+'" data-off="'+discy_js.off+'"></label></label><label class="explain explain-checkbox" for="'+discy_js.discy_theme+'['+data_id+'][group_'+ roles_j +'][ask_question]">'+discy_js.ask_question+'</label></div></div></div><div class="section section-checkbox"><div class="option"><div class="controls"><label class="switch" for="'+discy_js.discy_theme+'['+data_id+'][group_'+ roles_j +'][show_question]"><input id="'+discy_js.discy_theme+'['+data_id+'][group_'+ roles_j +'][show_question]" value="on" class="checkbox discy-input" type="checkbox" name="'+discy_js.discy_theme+'['+data_id+'][group_'+ roles_j +'][show_question]"><label for="'+discy_js.discy_theme+'['+data_id+'][group_'+ roles_j +'][show_question]" data-on="'+discy_js.on+'" data-off="'+discy_js.off+'"></label></label><label class="explain explain-checkbox" for="'+discy_js.discy_theme+'['+data_id+'][group_'+ roles_j +'][show_question]">'+discy_js.show_question+'</label></div></div></div><div class="section section-checkbox"><div class="option"><div class="controls"><label class="switch" for="'+discy_js.discy_theme+'['+data_id+'][group_'+ roles_j +'][add_answer]"><input id="'+discy_js.discy_theme+'['+data_id+'][group_'+ roles_j +'][add_answer]" value="on" class="checkbox discy-input" type="checkbox" name="'+discy_js.discy_theme+'['+data_id+'][group_'+ roles_j +'][add_answer]"><label for="'+discy_js.discy_theme+'['+data_id+'][group_'+ roles_j +'][add_answer]" data-on="'+discy_js.on+'" data-off="'+discy_js.off+'"></label></label><label class="explain explain-checkbox" for="'+discy_js.discy_theme+'['+data_id+'][group_'+ roles_j +'][add_answer]">'+discy_js.add_answer+'</label></div></div></div><div class="section section-checkbox"><div class="option"><div class="controls"><label class="switch" for="'+discy_js.discy_theme+'['+data_id+'][group_'+ roles_j +'][show_answer]"><input id="'+discy_js.discy_theme+'['+data_id+'][group_'+ roles_j +'][show_answer]" value="on" class="checkbox discy-input" type="checkbox" name="'+discy_js.discy_theme+'['+data_id+'][group_'+ roles_j +'][show_answer]"><label for="'+discy_js.discy_theme+'['+data_id+'][group_'+ roles_j +'][show_answer]" data-on="'+discy_js.on+'" data-off="'+discy_js.off+'"></label></label><label class="explain explain-checkbox" for="'+discy_js.discy_theme+'['+data_id+'][group_'+ roles_j +'][show_answer]">'+discy_js.show_answer+'</label></div></div></div><div class="section section-checkbox"><div class="option"><div class="controls"><label class="switch" for="'+discy_js.discy_theme+'['+data_id+'][group_'+ roles_j +'][add_post]"><input id="'+discy_js.discy_theme+'['+data_id+'][group_'+ roles_j +'][add_post]" value="on" class="checkbox discy-input" type="checkbox" name="'+discy_js.discy_theme+'['+data_id+'][group_'+ roles_j +'][add_post]"><label for="'+discy_js.discy_theme+'['+data_id+'][group_'+ roles_j +'][add_post]" data-on="'+discy_js.on+'" data-off="'+discy_js.off+'"></label></label><label class="explain explain-checkbox" for="'+discy_js.discy_theme+'['+data_id+'][group_'+ roles_j +'][add_post]">'+discy_js.add_post+'</label></div></div></div><div class="section section-checkbox"><div class="option"><div class="controls"><label class="switch" for="'+discy_js.discy_theme+'['+data_id+'][group_'+ roles_j +'][send_message]"><input id="'+discy_js.discy_theme+'['+data_id+'][group_'+ roles_j +'][send_message]" value="on" class="checkbox discy-input" type="checkbox" name="'+discy_js.discy_theme+'['+data_id+'][group_'+ roles_j +'][send_message]"><label for="'+discy_js.discy_theme+'['+data_id+'][group_'+ roles_j +'][send_message]" data-on="'+discy_js.on+'" data-off="'+discy_js.off+'"></label></label><label class="explain explain-checkbox" for="'+discy_js.discy_theme+'['+data_id+'][group_'+ roles_j +'][send_message]">'+discy_js.send_message+'</label></div></div></div><div class="section section-checkbox"><div class="option"><div class="controls"><label class="switch" for="'+discy_js.discy_theme+'['+data_id+'][group_'+ roles_j +'][upload_files]"><input id="'+discy_js.discy_theme+'['+data_id+'][group_'+ roles_j +'][upload_files]" value="on" class="checkbox discy-input" type="checkbox" name="'+discy_js.discy_theme+'['+data_id+'][group_'+ roles_j +'][upload_files]"><label for="'+discy_js.discy_theme+'['+data_id+'][group_'+ roles_j +'][upload_files]" data-on="'+discy_js.on+'" data-off="'+discy_js.off+'"></label></label><label class="explain explain-checkbox" for="'+discy_js.discy_theme+'['+data_id+'][group_'+ roles_j +'][upload_files]">'+discy_js.upload_files+'</label></div></div></div></div></div></li>');
		...
		jQuery(".discy_framework .add-item.add-item-2.add-item-6").on("click",function () {
			...
			if (jQuery("#"+item_id+'_'+select_val).length) {
				...
				jQuery("#"+addto+"-ul").append('<li class="categories" id="'+item_id+'_'+select_val+'"><div class="widget-head"><'+(toadd == 'yes'?'label':'span')+'>'+select_text+'</'+(toadd == 'yes'?'label':'span')+'>'+(toadd == 'yes'?'':'</div>')+(toadd == 'yes'?'<input name="'+item_name+'[cat-'+select_val+'][cat]" value="yes" type="hidden">':'')+'<input name="'+item_name+'[cat-'+select_val+']'+(toadd == 'yes'?'[value]':'')+'" value="'+select_val+'" type="hidden"><div><a class="widget-handle"><span class="dashicons dashicons-editor-justify"></span></a><a class="'+(toadd == 'yes'?'del-cat-item ':'')+'del-builder-item"><span class="dashicons dashicons-trash"></span></a></div>'+(toadd == 'yes'?'</div>':'')+'</li>');
			}
		});
		...
		if (jQuery("#page_template").length) {
			...
			var page_template = jQuery(".editor-page-attributes__template select")
		}
		page_template.change(function () {
			...
			if (jQuery(".discy-admin-content .nav-tab[data-template]") !== undefined && jQuery(".nav-tab[data-template]") !== false) {
				if (jQuery(".nav-tab[data-template='"+page_template+"']").length) {
					...
					jQuery(".discy-admin-content .nav-tab[data-template='"+page_template+"']").addClass('nav-tab-active');
					jQuery(".discy-admin-content .nav-tab[data-template='"+page_template+"'],.discy_framework > .discy-group[data-template='"+page_template+"']").show().removeClass('hide');
				}else {
					...
					if (jQuery(".discy-admin-content .nav-tab.nav-tab-active")) {
						/* Has active tab */
					}else {
						jQuery('.discy_framework > .discy-group:not(.hide):first').animate({
							opacity: 'show',
							height: 'show'
						}, 200, function() {
							jQuery(this).removeClass('hide');
						});
						jQuery('.discy-admin-content .nav-tab-wrapper a:not(.hide):first').addClass('nav-tab-active');
					}
				}
			}
		});
	...
	function discy_admin_add_file(event, selector) {
		...
		if ( discy_admin_upload ) {
			...
			discy_admin_upload.on( 'select', function() {
				...
				discy_admin_selector.find('.upload').val(attachment.attributes.url);
	...
	function discy_admin_remove_file(selector) {
		...
		selector.find('.remove-file').unbind().addClass('upload-button').removeClass('remove-file').val(discy_js.upload_image);
	...
	var update_form_elements = function(container) {
		...
		container.find('.discy-form-elements .discy-form-text .discy-form-control,.discy-form-elements .discy-form-textarea .discy-form-control').each(function() {
			discy_form_change.call(this, jQuery(this).val());
		});
		
		container.find('.discy-form-elements .discy-form-select .discy-form-control,.discy-form-elements .discy-form-radio .discy-form-control,.discy-form-elements .discy-form-images .discy-form-control,.discy-form-elements .discy-form-checkbox .discy-form-control').each(function() {
			var ct = jQuery(this);
			var checked = [];
			if (ct.attr('type') == "checkbox") {
				if (ct.prop('checked')) {
		...
		container.find('.discy-form-elements .section-multicheck_sort,.discy-form-elements .section-multicheck').each(function() {
			var pt = jQuery(this),
					lastChecked = null;
		...
		container.find('.discy-radio-img-img').each(function () {
			...
			radio_img.show().click(function() {
				...
				discy_form_change.call(this, radio_img.data("value"));
			});
		});
		...
		container.find('.discy-form-date .discy-date').each(function() {
		   var t = this,
		...
		container.find('.section .sort-sections').each(function() {
		   var t = this;
			...
			if (!jQuery(t).hasClass("not-sort") && !jQuery(t).hasClass("sort-sections-with")) {
				jQuery(t).sortable({placeholder: "ui-state-highlight",handle: ".widget-head,.widget-handle",cancel: ".builder-toggle-open,.builder-toggle-close,.builder_clone,.del-builder-item"});
			}
		});
		...
		container.find('.discy-form-wp-editor').each(function() {
		   ...
		   var t = jQuery(this),
				...
				p_is_hidden = p.hasClass('discy-hide'),
	...
	*/
	...
	/* Datepicker */
	jQuery('.discy-datepicker,.builder-datepicker').datepicker();
	...
	function discy_admin_tabs(meta = '') {
		...
		if (discy_v != '' && jQuery(discy_v).length && !jQuery(discy_v + '-tab').hasClass('hide') ) {
			...
			jQuery('.discy-group:not(.hide):first').animate({
				opacity: 'show',
				height: 'show'
			}, 200, function() {
				jQuery(this).removeClass('hide');
	...
	/* Serialize */
	jQuery.fn.serialize = function (options) {
	...
	return this.map(function () {
		...
		.map(function (i, elem) {
			...
			name: elem.name,
			value: (o.checkboxesAsBools && this.type == 'checkbox')?(this.checked?val:0):val
			};
		}).get();
	};
	...
	if (jQuery('input.discy_save').length) {
	    jQuery("input.discy_save").click(function(){
	    	...
	    	jQuery("#loading").show();
	    	if (jQuery(".discy_editor").length && tinyMCE !== undefined && tinyMCE !== false) {
	    		tinyMCE.triggerSave();
	    	}
	    	
			var fromSerialize = jQuery('#main_options_form').serializeArray({ checkboxesAsBools: true });
			jQuery.post(discy_js.ajax_a,fromSerialize,function (data) {
