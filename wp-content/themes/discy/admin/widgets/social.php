		...
		echo ($before_widget);
			...
			<div class="widget-wrap">
				...
				$social = array(
					...
					array("name" => "Google",     "value" => "gplus",      "icon" => "gplus"),
					...
					<?php if (isset($sort_social) && is_array($sort_social)) {
						...
						foreach ($sort_social as $key_r => $value_r) {$k++;
							...
							if (isset($sort_social[$key_r]["default"]) && $sort_social[$key_r]["default"] == "yes") {
								...
								<li class="social-<?php echo esc_attr($sort_social_value)?>"><a title="<?php echo esc_attr($sort_social[$key_r]["name"]["value"])?>" href="<?php echo ($sort_social_value == "skype"?"skype:":"").($sort_social_value == "whatsapp"?"whatsapp://send?abid=":"").($sort_social_value != "skype" && $sort_social_value != "whatsapp"?esc_url($social_icon_h):$social_icon_h).($sort_social_value == "skype"?"?call":"").($sort_social_value == "whatsapp"?"&text=".esc_html__("Hello","discy"):"")?>"<?php echo ($sort_social_value != "skype" && $sort_social_value != "whatsapp"?" target='_blank'":"")?>><i class="icon-<?php echo esc_attr($sort_social[$key_r]["icon"]["value"])?>"></i></a></li>
							<?php }
						}
					}?>
				</ul>
